...
export async function runSync() {
  ...
  // --- Eliminar del visualizador las carpetas que ya no existen en Drive ---
  // (antes solo se registraba el evento de borrado, pero el documento en
  // Firestore quedaba huérfano y seguía apareciendo en el dashboard).
  for (const id of idsCarpetasBorradas) {
    batch.delete(adminDb.collection("carpetas").doc(id));
  }
