...
export function generarReportePorArea(areaNombre, carpetasDelArea, opts = {}) {
  ...
  function empujarSubEncabezado(nombre, nivel) {
    ...
    // Evita desbordamiento dividiendo el texto según el ancho disponible de la tabla
  ...
  autoTable(doc, {
    ...
    columnStyles: {
      ...
      1: { cellWidth: 89 }, // Ancho explícito para evitar fallos de cálculo con colSpan
