...
export function generarReportePorArea(areaNombre, carpetasDelArea, opts = {}) {
  ...
  function empujarFila(c, nivelVisual) {
    ...
    body.push([
      String(contadorFila++),
      { content: nombreMostrado, styles: { cellPadding: { top: 2, right: 2, bottom: 2, left: sangriaIzq } } },
    ...
    body.push([
      {
        ...
        styles: {
          ...
          fontSize: 7.5,
          halign: "left",
          cellPadding: { top: 2, right: 2, bottom: 2, left: sangriaIzq },
        },
      },
    ]);
  }
  ...
  function agruparRecursivo(items, nivelIdx, nivelVisual) {
    ...
    for (const key of orden) {
      if (key === "__directo__") {
        ...
        agruparRecursivo(subgrupos[key], nivelIdx + 1, nivelVisual + 1);
      }
    }
  }
