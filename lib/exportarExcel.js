...
export async function generarReporteExcelPorArea(areaNombre, carpetasDelArea) {
  ...
  function agregarSubEncabezado(nombre, nivel) {
    ...
    celda.font = { bold: true, size: esNivel1 ? 10.5 : 9, color: { argb: esNivel1 ? "FFFFFFFF" : "FF283C41" } };
    celda.fill = {
      type: "pattern",
      pattern: "solid",
      fgColor: { argb: esNivel1 ? NARANJA : nivel === 2 ? "FFDEE8EB" : nivel === 3 ? "FFE8EEF0" : "FFF0F4F6" },
    };
